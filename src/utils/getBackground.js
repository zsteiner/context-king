...
export default function getBackground(location) {
  const unsplashAccessKey =
    'da0c3c38dee4d331d700bdaa28239c63527295291b54765ff0612841fd9a8f5c';

  const api = `https://api.unsplash.com/photos/random?query=${location}&client_id=${unsplashAccessKey}&orientation=landscape`;
